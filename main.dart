    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ImageSection(image: 'szab.jpg'),
              TitleSection(name: 'Szabist', location: 'Karachi, Pakistan'),
              ButtonSection(),
              TextSection(
                description:
                    'The Shaheed Zulfikar Ali Bhutto Institute of Science and Technology (SZABIST) Library in Karachi is a comprehensive academic resource center designed to support the institution',
              ),
            ],
          ),
        ),
